...
public class PartnerRegistrationProfileDetails extends AppCompatActivity {
    ...
    public void next(View view) {
        ...
        else if(newPassword.getText().toString().trim().equals(""))
        {
            ...
            Intent intent = new Intent(getApplicationContext(), PartnerRegistrationVehicleDetails.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_partner_registration_profile_details);
